...
const AddFolder = ({ show, setShown }: modal['props']) => {
	...
	const createFolder = async (e: any) => {
		...
		!navigator.onLine ? toast.error(`Unsuccessful, You're Offline...`) : createFold()
		...
		<Modal show={show}>
			<ErrorBoundary>
				<div className={styles.add__slide__form}>
					...
					<span>
						<small>
							NOTE: This will be the default name of the folder which will contain any pictures you
							add here
						</small>
					</span>
